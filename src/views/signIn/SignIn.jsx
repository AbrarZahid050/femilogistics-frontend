        ...
        <Container sx={{ height: "100%" }}>
          ...
          >
            ...
            <div className="signUp-card">
              {/* card item #1 */}
              <h3 className="signUp-card-heading">Sign In</h3>
              ...
              <div>
                {/* //1 */}
                <div className="signIn-card-terms-forgetPassword ">
                  <p className="signUp-card-terms-forget-password primary-color">
                    <Link to="/forgotPassword" className="link-to-signIn-span">
                      Forgot Password?
                    </Link>
                  </p>
                </div>
                ...
                <div className="link-to-signIn-container">
                  <p className="link-to-signIn">
                    ...
                    <Link to="/" className="link-to-signIn-span">
                      <span> Sign Up</span>
                    </Link>
                  </p>
                </div>
